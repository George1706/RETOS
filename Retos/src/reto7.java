    ...
    public static void main(String[] args) throws Exception {
        ...
        for (i = 1; i <= cantidadVeces; i++) {
            ...
            if (opcionAleatoria == 1 && opcion == 1) {
                ...
                System.out.println("empate Le quedan: " + (cantidadVeces = (vida)) + " vidas y tu valor final es de: " + apuesta);
            } else if (opcionAleatoria == 2 && opcion == 1) {
                System.out.println("respuesta piedra");
                System.out.println(nombre + " has perdido la respuesta de la maquina es: " + opcionAleatoria
                        + " tu respuesta es: " + opcion + " y tu valor final es de: " + (tope - apuesta) + " le quedan: "
                        + (cantidadVeces = (vida - perdio)) + " vidas");
            } else if (opcionAleatoria == 3 && opcion == 1) {
                System.out.println("respuesta es piedra");
                System.out.println(nombre + " has ganado la respuesta de la maquina es: " + opcionAleatoria
                        + " tu respuesta es: " + opcion + " y tu valor final es de:" + (tope + apuesta) + " le quedan: "
