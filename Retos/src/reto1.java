...
public class reto1 {
    ...
    public static void main(String[] args) {
        ...
        // Se asigna en la variable gradosCentigrados la operación para realizar la
        // conversion con gradosFahrenheit y de igual manera en la variable kelvin
        ...
        System.out.println("Grados Fahrenheit:" + gradosFahrenheit + "Grados Centígrados:" + gradosCentigrados
